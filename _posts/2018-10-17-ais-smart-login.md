...
สำหรับ Username ก็คือเบอร์มือถือ และ Password ก็คือที่ได้มาจากการกด `*388*3#` โทรออก - โดยที่การใช้งานจะใช้ได้ทีละเครื่อง นั่นคือถ้าปกติตั้งค่าไว้ และใช้มือถือเข้า Wi-Fi Smart Login อยู่เป็นปกติ คือเจอเมื่อไหร่ก็ให้เข้าเองทันที พอเราจะย้ายเอา account เข้ามาใช้บน Notebook แทน ง่ายๆ ก็แค่ปิด Wi-Fi บนมือถือไปซะก่อน (สลับไปใช้ Data ผ่าน 4G ไปพลางๆ) ทำตามนี้ก็น่าจะเข้าใช้งาน AIS Smart Login จากเครื่อง Notebook ได้เรียบร้อยนะครับ
