...
description: พักนี้ลุ่มหลงงงงวยกับการใช้ Keyboard Shortcuts อยู่พอสมควรครับ และก็ไม่แน่ใจว่าขยับนิ้วบ่อย ๆ จะเป็นการช่วยป้องกันนิ้วล๊อคหรือเปล่า
tags:
- Keyboard Shortcuts
comments: true
---
...
ง่ายมากนะครับ จำง่าย ๆ ด้วย L-(L)eft / R-(R)ight / E-C(E)nter อืม ... หรือ อีนี่อะไร?
...
OK ครับสมควรแก่เวลา เอาสักแค่นี้ก่อนล่ะกัน คิดอะไรไม่ออกก็ `Ctrl`{: .key}+`/`{: .key} นะครับ - คืนนี้นอนหลับฝันดี ก่อนนอนช่วยแผ่เมตตาให้กับพวกผี ๆ ด้วยนะครับ
